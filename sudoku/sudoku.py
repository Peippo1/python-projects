...
def is_valid(puzzle, guess, row, col):
    ...
    # and then the square
    # this is tricky, but we want to get to where the 3x3 square starts 
...
def solve_sudoku(puzzle):
    ...
    # step 1: choose somewhere on the puzzle to make a guess using a helper function (find_next_empty)
